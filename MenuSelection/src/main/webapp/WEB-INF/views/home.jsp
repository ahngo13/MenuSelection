            ...
            <div class="navbar-header">
                ...
                <a href="http://creative-tim.com">
                     <div class="logo-container">
                        <div class="logo">
                            <img src="/resources/assets/img/new_logo.png">
                        </div>
                        <div class="brand">
                            Creative Tim
                        </div>
        ...
        <div id="images">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h4>Rounded Image</h4>
                    <img src="/resources/assets/img/mockup.png" alt="Rounded Image" class="img-rounded">
                    
                </div>
                <div class="col-md-4 col-sm-6">
                    <h4>Circle Image</h4>
                    <img src="/resources/assets/img/mockup.png" alt="Circle Image" class="img-circle">
                   
                </div>
                <div class="col-md-4 col-sm-6">
                    <h4>Thumbnail Image</h4>
                    <img src="/resources/assets/img/mockup.png" alt="Thumbnail Image" class="img-thumbnail">
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="/resources/assets/img/carousel_blue.png" alt="Awesome Image">
        </div>
        <div class="item">
          <img src="/resources/assets/img/carousel_green.png" alt="Awesome Image">
        </div>
        <div class="item">
          <img src="/resources/assets/img/carousel_red.png" alt="Awesome Image">
        </div>
      </div>
            ...
            <div class="row">
                <div class="col-md-7 col-md-offset-0 col-sm-10 col-sm-offset-1">
                    <div class="text-center">
                        <img src="/resources/assets/img/dulau.jpg" alt="Rounded Image" class="img-rounded img-responsive img-dog">
                    </div>
                </div>
